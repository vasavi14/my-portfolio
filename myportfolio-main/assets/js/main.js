    ...
    var imJs = {
        ...
        contactForm: function () {
            $('.rwt-dynamic-form').on('submit', function (e) {
                ...
                // Collect form data
                var formData = {
                    name: _self.find('input[name="name"]').val(),
                    email: _self.find('input[name="email"]').val(),
                    message: _self.find('textarea[name="message"]').val()
                };
        
                // Send the form data using EmailJS
                emailjs.send('service_l6goe33', 'template_0l7qt98', formData)
                .then(function(response) {
                    // Handle success
                    _self.closest('div').find('button[type="submit"]').removeAttr('disabled');
                    _self.find('.rn-btn').after('<div class="success-msg"><p>Thank you! Your message has been sent.</p></div>');
                    ...
                    // Handle error
                    console.error('EmailJS Error:', error); // Detailed error information
                    _self.closest('div').find('button[type="submit"]').removeAttr('disabled');
                    _self.find('.rn-btn').after('<div class="success-msg"><p>* Thank you! Your message has been sent</p></div>');
                });
            });
